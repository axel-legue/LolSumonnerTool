...
public class RetrofitConstants {
    ...
    public static final String API_ITEM_VERSION = "9.5.1";
    public static final String API_RUNE_VERSION = "7.23.1";
    public static final String API_MASTERY_VERSION = "7.23.1";
    public static final String API_SUMMONER_VERSION = "9.5.1";
    public static final String API_CHAMPION_VERSION = "9.5.1";
    public static final String API_PROFIL_ICON_VERSION = "9.5.1";
    public static final String API_MAP_VERSION = "9.5.1";
    public static final String API_LANGUAGE_VERSION = "9.5.1";
    public static final String API_STICKER_VERSION = "9.5.1";
