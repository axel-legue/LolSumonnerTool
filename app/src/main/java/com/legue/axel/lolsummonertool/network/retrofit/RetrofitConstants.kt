...
object RetrofitConstants {
    ...
    const val API_CHAMPION_VERSION = "9.10.1"
    const val API_SPELL_VERSION = "9.10.1"
    const val API_PASSIVE_VERSION = "9.10.1"
    const val API_PROFIL_ICON_VERSION = "9.10.1"
    const val API_MAP_VERSION = "9.10.1"
    const val API_LANGUAGE_VERSION = "9.10.1"
    const val API_STICKER_VERSION = "9.10.1"
    ...
    const val API_KEY_VALUE_LOL_SUMMONER_TOOL = "RGAPI-5bfa06fe-7de1-47e1-9df8-b3c63fa61dd6"
